...
export const MAIN_NAV_ITEMS: MainNavItem[] = [
  ...
  { id: 'ic-transfer-admin', path: '/ic-transfer-admin', label: 'IC Transfer (Admin)', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  { id: 'ic-funds', path: '/ic-funds', label: 'IC Funds', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  { id: 'ic-transfer', path: '/ic-transfer', label: 'IC Transfer', icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z' },
  ...
  { id: 'usdt', path: '/currency', label: 'Currency', icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H9V8h2v8zm4 0h-2V8h2v8z' },
...
const BRANCH_NAV_ORDER = [
  'dashboard', 'deals', 'funds', 'transactions-beta', 'ic-transfer-admin', 'ic-funds', 'ic-transfer',
